...
[![Corpus](https://img.shields.io/badge/corpus-97.6M%20entities-2f7d4f)](https://whiteintel.dev/coverage)
...
**97.6M+ entities across 29 fused registries** — every claim cited, every edge traced:
...
- **Live corpus:** ~97.6M entities across 29 fused registries. Live counts: [whiteintel.dev/api/public/stats](https://whiteintel.dev/api/public/stats).
