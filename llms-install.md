...
~150M entities and ~23.2M ownership/control edges fused from **39 registries** into one
source-cited graph, with sanctions/PEP screening, UBO chain tracing, and **in-flow dossier
purchase** (an agent can hand a permanent payment link to a human). **23 tools.** No account
...
The GitHub source always delivers the current server (23 tools). The npm package
